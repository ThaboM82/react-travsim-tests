  ...
  if (
    ...
    lists = {
      f0ziqq7gfn: {
        ...
        listName: "To Do",
        tasks: [
          { taskId: "fk8vs85v0wh", taskDescription: "Walk the dog" },
          { taskId: "kd3ve56f5fh", taskDescription: "Cook dinner" },
          { taskId: "ld45g5h4tyf", taskDescription: "Meeting with the boss" },
        ],
      },
      ...
      y0zitt47gfb: {
        ...
        listName: "Complete",
        tasks: [
          { taskId: "v0zigt47whc", taskDescription: "Submit assignment" },
          { taskId: "b0zi5t4rwhc", taskDescription: "Start a new job :) <3" },
        ],
      },
    };
    storeLists();
